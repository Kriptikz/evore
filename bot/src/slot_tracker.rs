//! SlotTracker - WebSocket subscription for real-time slot updates
//!
//! Uses WebSocket slot subscription for low-latency slot tracking.
//! Blockhash polling has been moved to BlockhashCache.
...
/// Tracks current slot via websocket subscription
